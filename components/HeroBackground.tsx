        ...
        <div className="sticky top-0 h-screen w-screen flex items-center justify-center bg-neutral-950 text-black">
          <div className="flex flex-col md:flex-row items-center justify-center mb-24 gap-4 md:gap-10 px-2 py-12">
            <div className="flex items-center justify-center w-full md:w-1/2">
              <div className="max-w-full md:max-w-3xl mx-auto bg-neutral-400 dark:bg-neutral-800 rounded-lg p-6 shadow-2xl shadow-slate-950 mb-12 md:mb-0">
                ...
                <p className="text-base text-gray-800 dark:text-gray-300 mb-4">
                  Hi, I'm{" "}
                  <span className="font-bold text-black">Farhin Rahman</span>, a
            ...
            <div className="flex items-center justify-center w-full md:w-1/2">
              ...
              >
                <div className="flex flex-col p-6 w-[340px] h-[280px] bg-neutral-700/80 backdrop-blur-md border border-slate-600/50 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="flex items-center space-x-4">
                    <div className="w-12 h-12 flex items-center justify-center bg-gradient-to-br from-pink-950 via-pink-800 to-black text-white font-semibold text-lg rounded-full shadow-md">
                      F
                    </div>
                    <div>
                  ...
                  <a
                    ...
                    className="mt-auto flex items-center justify-center w-full py-2 text-sm font-medium text-white bg-gradient-to-r from-pink-900 to-black rounded-lg shadow-md hover:opacity-90 transition-all"
                  >
                    View Profile
                  </a>
                </div>
