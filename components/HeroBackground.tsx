...
export default function AnimatedAbout() {
  ...
  }
  {
    /* <AnimatedParagraph delay={0.4}>
                A{" "}
                <HighlightedText>passionate Frontend Developer</HighlightedText>{" "}
              ...
              <AnimatedParagraph delay={0.8}>
                ...
                experimenting with design. I'm always eager to take on{" "}
                <HighlightedText>new challenges</HighlightedText> and grow as a
                developer.
              </AnimatedParagraph>
            </div>
          </div>
