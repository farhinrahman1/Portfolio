        ...
        <div className="flex">
          ...
          <div className="p-6 flex-1">
            ...
            <div className="mt-4 flex justify-end">
              <button
                className="flex items-center gap-1 text-sm font-medium text-gray-400 hover:text-white transition-colors bg-gray-800 hover:bg-gray-700 px-3 py-1 rounded-md"
          ...
          <div>
            {!showSkills ? (
              <button
                ...
                className="px-8 py-4 bg-gray-800 text-white rounded-lg hover:bg-gray-700 transition-colors shadow-lg flex items-center gap-2 mx-auto text-lg"
              >
